...
class InsertionSort {
    ...
    fun `sorting works as expected when n = 10, 50, 100, 1000`() {
        ...
        assertThat((sort(shuffled10.toMutableList())), equalTo(sorted10))

        val sorted50 = List(50) { i -> i + 1 }
        val shuffled50 = sorted50.shuffled()
        assertThat((sort(shuffled50.toMutableList())), equalTo(sorted50))

        val sorted100 = List(100) { i -> i + 1 }
        val shuffled100 = sorted100.shuffled()
        assertThat((sort(shuffled100.toMutableList())), equalTo(sorted100))

        val sorted1000 = List(1000) { i -> i + 1 }
        val shuffled1000 = sorted1000.shuffled()
        assertThat((sort(shuffled1000.toMutableList())), equalTo(sorted1000))
